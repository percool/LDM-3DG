...
# One latent vetcor:
# dim_in is corresponding to z_C (conditioned latent vector)
# Two conditions:
# dim_emb2d is corresponding to z_G (2d topo ligand embeddings). Embeded by the pretrained auto-encoder.
# dim_condition is corresponding to protein embeddings. Embeded by the EGNNModel. EGNNModel will also be trained in the diffusion process.
